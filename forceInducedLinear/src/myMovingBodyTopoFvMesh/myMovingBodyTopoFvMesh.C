...
#include "myMovingBodyTopoFvMesh.H"
#include "foamTime.H"
...
namespace Foam
{
    defineTypeNameAndDebug(myMovingBodyTopoFvMesh, 0);

    addToRunTimeSelectionTable
    (
        topoChangerFvMesh,
        myMovingBodyTopoFvMesh,
        IOobject
    );
}
...
Foam::myMovingBodyTopoFvMesh::calcMotionMask() const
{
...
void Foam::myMovingBodyTopoFvMesh::addZonesAndModifiers()
{
    // Add zones and modifiers for motion action

    if (topoChanger_.size() > 0)
    {
        Info<< "void myMovingBodyTopoFvMesh::addZonesAndModifiers() : "
...
Foam::myMovingBodyTopoFvMesh::myMovingBodyTopoFvMesh(const IOobject& io)
:
    ...
    SBMFPtr_(mysolidBodyMotionFunction::New(dict_, time())),
    motionMask_()
{
...
Foam::myMovingBodyTopoFvMesh::~myMovingBodyTopoFvMesh()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::myMovingBodyTopoFvMesh::update()
{
